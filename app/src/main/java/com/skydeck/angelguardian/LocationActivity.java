...
public class LocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout geography = (LinearLayout) findViewById(R.id.geo_location_layout);
        mGeoView = (TextView) geography.findViewById(R.id.geo_view);
        mGeoView.append(" --- helllo --- geo location info");
        mRgeoView = (TextView) geography.findViewById(R.id.rgeo_view);
...
//                }, 3000);
    ...
    void savePreferences() {
        // Edit and commit
        RelativeLayout location = (RelativeLayout) findViewById(R.id.location);
        EditText username_edit = (EditText) location.findViewById(R.id.email_view);
        EditText password_edit = (EditText) location.findViewById(R.id.password_view);
